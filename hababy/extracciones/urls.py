...
urlpatterns = [
    ...
    path('test_o_sullivan_curva_larga/eliminar_cita_test_o_sullivan_curva_larga/', views.eliminar_cita_test_o_sullivan_curva_larga,
         name='eliminar_cita_test_o_sullivan_curva_larga'),
